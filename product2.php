...
$bid_sql = mysqli_query($con,"SELECT * FROM bid WHERE Bid_Amount = (SELECT MAX(Bid_Amount) FROM bid WHERE Item_Id = 7) AND Item_Id = 7");
...
<html>
    ...
    <body>
        ...
        <div class="main">
        <div class="container">
            <img src="images/Fash 1.jpeg" class="productimg">
            <div class="content-box">

                <div class="text">
        <h1 class="productname">Denim</h1>
                    ...
                    <form action="#" method="post">
                        <input type = "submit" value = "Wishlist" class = "wishlistbtn">
                    </form>
            ...
            <part2 style="display: flex;">
                ...
                <post1 style="width: 30%;">
                   <post1-frame class="post-frame">
                    <img src="images/rev1.png" style="width: 300px; height: 300px;" >
                </post1-frame>
                </post1>
                
                <post2 style="width: 30%;">
                    <post2-frame class="post-frame">
                        <img src="images/rev2.png" style="width: 300px; height: 300px;" >
                    </post2-frame>
                    </post2>
        
                    <post3 style="width: 30%;">
                        <post3-frame class="post-frame">
                            <img src="images/rev3.png" style="width: 300px; height: 300px;" >
                        </post3-frame>
                        </post3>
                        <post4 style="width: 30%;">
                            <post4-frame class="post-frame">
                             <img src="images/rev4.png" style="width: 300px; height: 300px;" >
                        </post4-frame>
                        </post4>    
